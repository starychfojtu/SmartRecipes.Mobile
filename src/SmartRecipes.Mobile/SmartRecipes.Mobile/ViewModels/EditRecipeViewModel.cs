...
//            );
//            Ingredients = ImmutableDictionary.Create<IFoodstuff, float>();
...
//
//        public IImmutableDictionary<IFoodstuff, float> Ingredients { get; set; }
//
...
//            var newFoodstuffs = foodstuffs.Where(f => !Ingredients.ContainsKey(f)).Select(f => new KeyValuePair<IFoodstuff, float>(f, f.BaseAmount.Count));
...
//        }
//
//        private Unit UpdateIngredients(IImmutableDictionary<IFoodstuff, float> newIngredients)
//        {
